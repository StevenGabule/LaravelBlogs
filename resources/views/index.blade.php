            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    <div class="post-thumb">
                        <img src="{{ $first_post->featured }}" class="img-fluid" alt="seo">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single', ['id' => $third_post->category->id]) }}">{{$third_post->category->featured}}</a>
                                        </span>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($CSS3->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div
                                            class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled"
                                            data-offset="5">
