...
<head lang="en">
    ...
    <style>.padded-50 { padding: 40px; }.text-center { text-align: center; }</style>
</head>
...
<!-- ...end JS Script -->
<script type="text/javascript" src="https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5bdccd37bc145bb8" defer></script>
</body>
</html>
